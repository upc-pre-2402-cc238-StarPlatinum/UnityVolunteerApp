...
class AuthRepository {
  ...
  Future<Map<String, dynamic>> registerUser(UserRegisterModel user) async {
    return await _authService.registerUser(user);  // Retornar la respuesta
  }

  // Login de usuario
  Future<Map<String, dynamic>> loginUser(LoginModel userLogin) async {
    return await _authService.loginUser(userLogin);  // Retornar la respuesta del login
  }

  //actualizar datos de la organización
  Future<void> saveOrganizacionData(int usuarioId, String nombreOrganizacion, String tipoOrganizacion, String sitioWeb) async {
    return await _authService.updateOrganizacionData(usuarioId, nombreOrganizacion, tipoOrganizacion, sitioWeb);
  }

  //actualizar datos del voluntario

  Future<void> saveVoluntarioData(int usuarioId, String intereses, String experiencia, String disponibilidad) async {
    return await _authService.updateVoluntarioData(usuarioId, intereses, experiencia, disponibilidad);
  }
