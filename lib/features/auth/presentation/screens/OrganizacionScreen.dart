    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            SizedBox(height: 60),  // Más espacio en la parte superior
            // Encabezado con ícono
            Column(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Icon(
                  Icons.business_outlined,  // Ícono de organización
                  size: 100,
                  color: Color(0xFF3894B6),  // Color de la organización
                ),
                SizedBox(height: 20),
                Text(
                  '¡Hola, ${widget.nombre}!',
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(0xFFFF6A00),  // Color del botón
